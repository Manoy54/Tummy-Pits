...
// Next.js static asset paths from /public
const cardGLB = '/card.glb';
const lanyardPng = '/lanyard.png';

// @ts-expect-error - meshline types are incompatible with r3f v9
...
export default function Lanyard({
  ...
  return (
    <div className="relative z-0 w-full h-full flex justify-center items-center overflow-hidden">
      <Canvas
        camera={{ position, fov }}
    ...
    <>
      ...
      <mesh ref={band}>
        ...
        <meshLineMaterial
          color="white"
          depthTest={false}
          resolution={[size.width || 1000, size.height || 1000]}
          useMap
          map={texture}
          repeat={[-4, 1]}
