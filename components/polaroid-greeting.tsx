  ...
  return (
    <div className="relative w-full max-w-3xl aspect-[4/5] sm:aspect-auto sm:h-[80vh] flex items-center justify-center p-8 z-40 mx-auto">
      ...
      >
        ...
        {/* Photo Area */}
        <div className="w-full aspect-square bg-slate-200 flex flex-col items-center justify-center relative overflow-hidden group shadow-[inset_0_4px_10px_rgba(0,0,0,0.05)] border-2 border-transparent">
          <img 
            src="/main_card/436ef50a-54f9-4c1f-a4f2-4c98f935faa3 (1).jpg" 
            alt="Favorite B-Day Memory" 
